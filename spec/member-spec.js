...
frisby.create('add a new member')
  .post('http://localhost:8082/register', {"user_name": "test4", "password": "123467", "name" : "tester4", "email" : "kkk@kkk.com"}, {json: true})
  .expectStatus(200)
...
frisby.create('login')
  .post('http://localhost:8082/login', {"user_name": "test3", "password": "123467"}, {json: true})
  .expectStatus(200)
  .expectHeaderContains('content-type', 'application/json')
  .inspectBody()
  .toss()
...
frisby.create('changePassword')
  .post('http://localhost:8082/changePassword', {"user_name": "test3", "password": "999999", "new_password": "123456"}, {json: true})
  .expectStatus(200)
  .expectHeaderContains('content-type', 'application/json')
  .inspectBody()
  .toss()
...
frisby.create('verify member')
  .post('http://localhost:8082/verifyMember', {"user_name": "test3"}, {json: true})
  .expectStatus(200)
  .expectHeaderContains('content-type', 'application/json')
  .inspectBody()
  .toss()
